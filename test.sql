...
INSERT INTO app_user ( id, app_user_role, email, enabled, first_name, last_name, locked, password, username)
        VALUES (  1, 'ADMIN', 'admin@admin.com', true , 'admin', 'admin', false, '$2a$12$07F5909VcxNf89c5phIUteTAdM2ehd4shN8kD4e63z54HrFZIqtzK', 'admin');